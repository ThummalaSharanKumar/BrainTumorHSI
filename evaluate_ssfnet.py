...
# --- Dataset Class Definition (The dual-output version) ---
...
# --- SSF-NET EVALUATION CONFIGURATION ---
EVAL_CONFIG = {
    "BATCH_SIZE": 2,
    ...
    "NUM_CLASSES": 5,
    "REDUCER_PATH": 'pca_model.pkl', # Use the winning reducer for the spatial branch
    "MODEL_PATH": 'best_ssfnet_model.pth',
}

# --- MAIN EXECUTION SCRIPT ---
if __name__ == "__main__":
    print(f"--- Starting Final Evaluation of SSF-Net Model ---")
    ...
    with torch.no_grad():
        for hsi_spatial, hsi_spectral, mask in tqdm(test_loader, desc="Evaluating SSF-Net on Test Set"):
